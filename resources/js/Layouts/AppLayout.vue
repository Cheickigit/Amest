...
const page = usePage(); // ← IMPORTANT : Ajoutez cette ligne
const showingNavigationDropdown = ref(false);

// Computed properties pour les vérifications - UTILISEZ `page.props` au lieu de `$page.props`
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50 dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700 transition ease-in-out duration-150">
                                                {{ hasCurrentTeam ? user.current_team.name : 'Select Team' }}
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="jetstream.hasTeamFeatures">
                                ...
                                <!-- Team Settings -->
                                <ResponsiveNavLink v-if="hasCurrentTeam"
                                                  :href="route('teams.show', currentTeam)"
                                                  :active="route().current('teams.show')">
                                    Team Settings
                                </ResponsiveNavLink>

                                <ResponsiveNavLink v-if="jetstream.canCreateTeams"
