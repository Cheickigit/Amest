...
Route::get('/annonces-archives', fn () => Inertia::render('Public/AnnouncementsArchive'))->name('announcements-archive');
...
Route::get('/contact', fn () => Inertia::render('Public/Contact', [
    'contact' => [
        ...
        'whatsapp_href' => 'https://wa.me/21624282332',
        'email'         => 'amestsahel04@gmail.com',
        'city'          => 'Sousse, Tunisie',
        'hours'         => 'Lun–Dim : H24',
        'plus_code'     => 'Sousse, Gouvernorat Sousse, Tunisie',
    ],
]))->name('public.contact');
